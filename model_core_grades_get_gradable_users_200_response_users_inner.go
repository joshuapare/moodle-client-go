...
// checks if the CoreGradesGetGradableUsers200ResponseUsersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoreGradesGetGradableUsers200ResponseUsersInner{}

// CoreGradesGetGradableUsers200ResponseUsersInner struct for CoreGradesGetGradableUsers200ResponseUsersInner
type CoreGradesGetGradableUsers200ResponseUsersInner struct {
	// Postal address
...
func NewCoreGradesGetGradableUsers200ResponseUsersInner() *CoreGradesGetGradableUsers200ResponseUsersInner {
	this := CoreGradesGetGradableUsers200ResponseUsersInner{}
	return &this
}
...
func (o CoreGradesGetGradableUsers200ResponseUsersInner) MarshalJSON() ([]byte, error) {
...
func (o CoreGradesGetGradableUsers200ResponseUsersInner) ToMap() (map[string]interface{}, error) {
...
type NullableCoreGradesGetGradableUsers200ResponseUsersInner struct {
	value *CoreGradesGetGradableUsers200ResponseUsersInner
	isSet bool
}

func (v NullableCoreGradesGetGradableUsers200ResponseUsersInner) Get() *CoreGradesGetGradableUsers200ResponseUsersInner {
	return v.value
}

func (v *NullableCoreGradesGetGradableUsers200ResponseUsersInner) Set(val *CoreGradesGetGradableUsers200ResponseUsersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreGradesGetGradableUsers200ResponseUsersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreGradesGetGradableUsers200ResponseUsersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreGradesGetGradableUsers200ResponseUsersInner(val *CoreGradesGetGradableUsers200ResponseUsersInner) *NullableCoreGradesGetGradableUsers200ResponseUsersInner {
	return &NullableCoreGradesGetGradableUsers200ResponseUsersInner{value: val, isSet: true}
}

func (v NullableCoreGradesGetGradableUsers200ResponseUsersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreGradesGetGradableUsers200ResponseUsersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
