...
// checks if the ModAssignGetUserFlags200ResponseWarningsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModAssignGetUserFlags200ResponseWarningsInner{}

// ModAssignGetUserFlags200ResponseWarningsInner warning
type ModAssignGetUserFlags200ResponseWarningsInner struct {
...
func NewModAssignGetUserFlags200ResponseWarningsInner() *ModAssignGetUserFlags200ResponseWarningsInner {
	this := ModAssignGetUserFlags200ResponseWarningsInner{}
...
func (o ModAssignGetUserFlags200ResponseWarningsInner) MarshalJSON() ([]byte, error) {
...
func (o ModAssignGetUserFlags200ResponseWarningsInner) ToMap() (map[string]interface{}, error) {
...
type NullableModAssignGetUserFlags200ResponseWarningsInner struct {
	value *ModAssignGetUserFlags200ResponseWarningsInner
	isSet bool
}

func (v NullableModAssignGetUserFlags200ResponseWarningsInner) Get() *ModAssignGetUserFlags200ResponseWarningsInner {
	return v.value
}

func (v *NullableModAssignGetUserFlags200ResponseWarningsInner) Set(val *ModAssignGetUserFlags200ResponseWarningsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableModAssignGetUserFlags200ResponseWarningsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableModAssignGetUserFlags200ResponseWarningsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModAssignGetUserFlags200ResponseWarningsInner(val *ModAssignGetUserFlags200ResponseWarningsInner) *NullableModAssignGetUserFlags200ResponseWarningsInner {
	return &NullableModAssignGetUserFlags200ResponseWarningsInner{value: val, isSet: true}
}

func (v NullableModAssignGetUserFlags200ResponseWarningsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModAssignGetUserFlags200ResponseWarningsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
