...
// checks if the CoreBlogGetEntries200ResponseEntriesInnerTagsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoreBlogGetEntries200ResponseEntriesInnerTagsInner{}

// CoreBlogGetEntries200ResponseEntriesInnerTagsInner struct for CoreBlogGetEntries200ResponseEntriesInnerTagsInner
type CoreBlogGetEntries200ResponseEntriesInnerTagsInner struct {
...
func NewCoreBlogGetEntries200ResponseEntriesInnerTagsInner() *CoreBlogGetEntries200ResponseEntriesInnerTagsInner {
	this := CoreBlogGetEntries200ResponseEntriesInnerTagsInner{}
	var flag int32 = 0
	this.Flag = &flag
	var id int32 = null
	this.Id = &id
...
func (o CoreBlogGetEntries200ResponseEntriesInnerTagsInner) MarshalJSON() ([]byte, error) {
...
func (o CoreBlogGetEntries200ResponseEntriesInnerTagsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCoreBlogGetEntries200ResponseEntriesInnerTagsInner struct {
	value *CoreBlogGetEntries200ResponseEntriesInnerTagsInner
	isSet bool
}

func (v NullableCoreBlogGetEntries200ResponseEntriesInnerTagsInner) Get() *CoreBlogGetEntries200ResponseEntriesInnerTagsInner {
	return v.value
}

func (v *NullableCoreBlogGetEntries200ResponseEntriesInnerTagsInner) Set(val *CoreBlogGetEntries200ResponseEntriesInnerTagsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreBlogGetEntries200ResponseEntriesInnerTagsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreBlogGetEntries200ResponseEntriesInnerTagsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreBlogGetEntries200ResponseEntriesInnerTagsInner(val *CoreBlogGetEntries200ResponseEntriesInnerTagsInner) *NullableCoreBlogGetEntries200ResponseEntriesInnerTagsInner {
	return &NullableCoreBlogGetEntries200ResponseEntriesInnerTagsInner{value: val, isSet: true}
}

func (v NullableCoreBlogGetEntries200ResponseEntriesInnerTagsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreBlogGetEntries200ResponseEntriesInnerTagsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
