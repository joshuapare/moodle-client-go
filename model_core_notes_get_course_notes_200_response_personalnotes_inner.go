...
// checks if the CoreNotesGetCourseNotes200ResponsePersonalnotesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoreNotesGetCourseNotes200ResponsePersonalnotesInner{}

// CoreNotesGetCourseNotes200ResponsePersonalnotesInner struct for CoreNotesGetCourseNotes200ResponsePersonalnotesInner
type CoreNotesGetCourseNotes200ResponsePersonalnotesInner struct {
...
func NewCoreNotesGetCourseNotes200ResponsePersonalnotesInner() *CoreNotesGetCourseNotes200ResponsePersonalnotesInner {
	this := CoreNotesGetCourseNotes200ResponsePersonalnotesInner{}
	return &this
}
...
func (o CoreNotesGetCourseNotes200ResponsePersonalnotesInner) MarshalJSON() ([]byte, error) {
...
func (o CoreNotesGetCourseNotes200ResponsePersonalnotesInner) ToMap() (map[string]interface{}, error) {
...
type NullableCoreNotesGetCourseNotes200ResponsePersonalnotesInner struct {
	value *CoreNotesGetCourseNotes200ResponsePersonalnotesInner
	isSet bool
}

func (v NullableCoreNotesGetCourseNotes200ResponsePersonalnotesInner) Get() *CoreNotesGetCourseNotes200ResponsePersonalnotesInner {
	return v.value
}

func (v *NullableCoreNotesGetCourseNotes200ResponsePersonalnotesInner) Set(val *CoreNotesGetCourseNotes200ResponsePersonalnotesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreNotesGetCourseNotes200ResponsePersonalnotesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreNotesGetCourseNotes200ResponsePersonalnotesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreNotesGetCourseNotes200ResponsePersonalnotesInner(val *CoreNotesGetCourseNotes200ResponsePersonalnotesInner) *NullableCoreNotesGetCourseNotes200ResponsePersonalnotesInner {
	return &NullableCoreNotesGetCourseNotes200ResponsePersonalnotesInner{value: val, isSet: true}
}

func (v NullableCoreNotesGetCourseNotes200ResponsePersonalnotesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreNotesGetCourseNotes200ResponsePersonalnotesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
