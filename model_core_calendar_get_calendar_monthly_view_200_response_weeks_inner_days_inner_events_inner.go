...
// checks if the CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner{}

// CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner struct for CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner
type CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner struct {
...
func NewCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner() *CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner {
	this := CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner{}
...
func (o CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner) MarshalJSON() ([]byte, error) {
...
func (o CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner struct {
	value *CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner
	isSet bool
}

func (v NullableCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner) Get() *CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner {
	return v.value
}

func (v *NullableCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner) Set(val *CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner(val *CoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner) *NullableCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner {
	return &NullableCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner{value: val, isSet: true}
}

func (v NullableCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreCalendarGetCalendarMonthlyView200ResponseWeeksInnerDaysInnerEventsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
