...
// checks if the CoreGroupGetActivityAllowedGroups200ResponseGroupsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoreGroupGetActivityAllowedGroups200ResponseGroupsInner{}

// CoreGroupGetActivityAllowedGroups200ResponseGroupsInner struct for CoreGroupGetActivityAllowedGroups200ResponseGroupsInner
type CoreGroupGetActivityAllowedGroups200ResponseGroupsInner struct {
	// course id
...
func NewCoreGroupGetActivityAllowedGroups200ResponseGroupsInner() *CoreGroupGetActivityAllowedGroups200ResponseGroupsInner {
	this := CoreGroupGetActivityAllowedGroups200ResponseGroupsInner{}
...
func (o CoreGroupGetActivityAllowedGroups200ResponseGroupsInner) MarshalJSON() ([]byte, error) {
...
func (o CoreGroupGetActivityAllowedGroups200ResponseGroupsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCoreGroupGetActivityAllowedGroups200ResponseGroupsInner struct {
	value *CoreGroupGetActivityAllowedGroups200ResponseGroupsInner
	isSet bool
}

func (v NullableCoreGroupGetActivityAllowedGroups200ResponseGroupsInner) Get() *CoreGroupGetActivityAllowedGroups200ResponseGroupsInner {
	return v.value
}

func (v *NullableCoreGroupGetActivityAllowedGroups200ResponseGroupsInner) Set(val *CoreGroupGetActivityAllowedGroups200ResponseGroupsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreGroupGetActivityAllowedGroups200ResponseGroupsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreGroupGetActivityAllowedGroups200ResponseGroupsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreGroupGetActivityAllowedGroups200ResponseGroupsInner(val *CoreGroupGetActivityAllowedGroups200ResponseGroupsInner) *NullableCoreGroupGetActivityAllowedGroups200ResponseGroupsInner {
	return &NullableCoreGroupGetActivityAllowedGroups200ResponseGroupsInner{value: val, isSet: true}
}

func (v NullableCoreGroupGetActivityAllowedGroups200ResponseGroupsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreGroupGetActivityAllowedGroups200ResponseGroupsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
