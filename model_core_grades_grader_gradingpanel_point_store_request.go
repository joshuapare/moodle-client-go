...
// checks if the CoreGradesGraderGradingpanelPointStoreRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoreGradesGraderGradingpanelPointStoreRequest{}

// CoreGradesGraderGradingpanelPointStoreRequest struct for CoreGradesGraderGradingpanelPointStoreRequest
type CoreGradesGraderGradingpanelPointStoreRequest struct {
...
type _CoreGradesGraderGradingpanelPointStoreRequest CoreGradesGraderGradingpanelPointStoreRequest
...
func NewCoreGradesGraderGradingpanelPointStoreRequest(component string, contextid int32, formdata string, gradeduserid int32, itemname string) *CoreGradesGraderGradingpanelPointStoreRequest {
	this := CoreGradesGraderGradingpanelPointStoreRequest{}
...
func (o CoreGradesGraderGradingpanelPointStoreRequest) MarshalJSON() ([]byte, error) {
...
func (o CoreGradesGraderGradingpanelPointStoreRequest) ToMap() (map[string]interface{}, error) {
...
func (o *CoreGradesGraderGradingpanelPointStoreRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCoreGradesGraderGradingpanelPointStoreRequest := _CoreGradesGraderGradingpanelPointStoreRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCoreGradesGraderGradingpanelPointStoreRequest)

	if err != nil {
		return err
	}

	*o = CoreGradesGraderGradingpanelPointStoreRequest(varCoreGradesGraderGradingpanelPointStoreRequest)

	return err
}

type NullableCoreGradesGraderGradingpanelPointStoreRequest struct {
	value *CoreGradesGraderGradingpanelPointStoreRequest
	isSet bool
}

func (v NullableCoreGradesGraderGradingpanelPointStoreRequest) Get() *CoreGradesGraderGradingpanelPointStoreRequest {
	return v.value
}

func (v *NullableCoreGradesGraderGradingpanelPointStoreRequest) Set(val *CoreGradesGraderGradingpanelPointStoreRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreGradesGraderGradingpanelPointStoreRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreGradesGraderGradingpanelPointStoreRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreGradesGraderGradingpanelPointStoreRequest(val *CoreGradesGraderGradingpanelPointStoreRequest) *NullableCoreGradesGraderGradingpanelPointStoreRequest {
	return &NullableCoreGradesGraderGradingpanelPointStoreRequest{value: val, isSet: true}
}

func (v NullableCoreGradesGraderGradingpanelPointStoreRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreGradesGraderGradingpanelPointStoreRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
