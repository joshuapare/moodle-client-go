...
// checks if the BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner{}

// BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner struct for BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner
type BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner struct {
...
func NewBlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner() *BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner {
	this := BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner{}
	var courseid int32 = null
	this.Courseid = &courseid
	var quantity int32 = null
	this.Quantity = &quantity
	var roleid int32 = null
	this.Roleid = &roleid
	var suspend int32 = null
...
func (o BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner) MarshalJSON() ([]byte, error) {
...
func (o BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner) ToMap() (map[string]interface{}, error) {
...
type NullableBlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner struct {
	value *BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner
	isSet bool
}

func (v NullableBlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner) Get() *BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner {
	return v.value
}

func (v *NullableBlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner) Set(val *BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner(val *BlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner) *NullableBlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner {
	return &NullableBlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner{value: val, isSet: true}
}

func (v NullableBlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockIomadCompanyAdminEnrolUsersRequestEnrolmentsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
