...
// checks if the CoreNotesGetNotes200ResponseWarningsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoreNotesGetNotes200ResponseWarningsInner{}

// CoreNotesGetNotes200ResponseWarningsInner warning
type CoreNotesGetNotes200ResponseWarningsInner struct {
	// item is always 'note'
...
func NewCoreNotesGetNotes200ResponseWarningsInner() *CoreNotesGetNotes200ResponseWarningsInner {
	this := CoreNotesGetNotes200ResponseWarningsInner{}
...
func (o CoreNotesGetNotes200ResponseWarningsInner) MarshalJSON() ([]byte, error) {
...
func (o CoreNotesGetNotes200ResponseWarningsInner) ToMap() (map[string]interface{}, error) {
...
type NullableCoreNotesGetNotes200ResponseWarningsInner struct {
	value *CoreNotesGetNotes200ResponseWarningsInner
	isSet bool
}

func (v NullableCoreNotesGetNotes200ResponseWarningsInner) Get() *CoreNotesGetNotes200ResponseWarningsInner {
	return v.value
}

func (v *NullableCoreNotesGetNotes200ResponseWarningsInner) Set(val *CoreNotesGetNotes200ResponseWarningsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreNotesGetNotes200ResponseWarningsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreNotesGetNotes200ResponseWarningsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreNotesGetNotes200ResponseWarningsInner(val *CoreNotesGetNotes200ResponseWarningsInner) *NullableCoreNotesGetNotes200ResponseWarningsInner {
	return &NullableCoreNotesGetNotes200ResponseWarningsInner{value: val, isSet: true}
}

func (v NullableCoreNotesGetNotes200ResponseWarningsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreNotesGetNotes200ResponseWarningsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
