...
// checks if the ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner{}

// ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner struct for ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner
type ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner struct {
...
func NewModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner() *ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner {
	this := ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner{}
...
func (o ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner) MarshalJSON() ([]byte, error) {
...
func (o ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner) ToMap() (map[string]interface{}, error) {
...
type NullableModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner struct {
	value *ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner
	isSet bool
}

func (v NullableModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner) Get() *ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner {
	return v.value
}

func (v *NullableModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner) Set(val *ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner) {
	v.value = val
	v.isSet = true
}

func (v NullableModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner) IsSet() bool {
	return v.isSet
}

func (v *NullableModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner(val *ModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner) *NullableModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner {
	return &NullableModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner{value: val, isSet: true}
}

func (v NullableModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModWorkshopGetGradesReport200ResponseReportGradesInnerReviewedbyInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
