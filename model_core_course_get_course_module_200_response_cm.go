...
// checks if the CoreCourseGetCourseModule200ResponseCm type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoreCourseGetCourseModule200ResponseCm{}

// CoreCourseGetCourseModule200ResponseCm struct for CoreCourseGetCourseModule200ResponseCm
type CoreCourseGetCourseModule200ResponseCm struct {
	// Time added
	Added *int32 `json:"added,omitempty"`
	Advancedgrading []CoreCourseGetCourseModule200ResponseCmAdvancedgradingInner `json:"advancedgrading,omitempty"`
	...
	Outcomes []CoreCourseGetCourseModule200ResponseCmOutcomesInner `json:"outcomes,omitempty"`
	// Scale items (if used)
...
type _CoreCourseGetCourseModule200ResponseCm CoreCourseGetCourseModule200ResponseCm
...
func NewCoreCourseGetCourseModule200ResponseCm(completion int32, course int32, groupingid int32, groupmode int32, id int32, instance int32, modname string, module int32, name string, section int32, sectionnum int32) *CoreCourseGetCourseModule200ResponseCm {
	this := CoreCourseGetCourseModule200ResponseCm{}
	var added int32 = null
	this.Added = &added
	var availability string = "null"
	this.Availability = &availability
	this.Completion = completion
	var completionexpected int32 = null
	this.Completionexpected = &completionexpected
	var completiongradeitemnumber int32 = null
	this.Completiongradeitemnumber = &completiongradeitemnumber
	var completionpassgrade int32 = null
	this.Completionpassgrade = &completionpassgrade
	var completionview int32 = null
	this.Completionview = &completionview
	this.Course = course
	var downloadcontent int32 = null
	this.Downloadcontent = &downloadcontent
	var grade float32 = null
	this.Grade = &grade
	var gradecat int32 = null
	this.Gradecat = &gradecat
	var gradepass string = "null"
	...
	var showdescription int32 = null
	this.Showdescription = &showdescription
	var visible int32 = null
	this.Visible = &visible
	var visibleold int32 = null
	this.Visibleold = &visibleold
	var visibleoncoursepage int32 = null
...
func (o *CoreCourseGetCourseModule200ResponseCm) GetAdvancedgrading() []CoreCourseGetCourseModule200ResponseCmAdvancedgradingInner {
	if o == nil || IsNil(o.Advancedgrading) {
		var ret []CoreCourseGetCourseModule200ResponseCmAdvancedgradingInner
		return ret
	}
...
// SetAdvancedgrading gets a reference to the given []CoreCourseGetCourseModule200ResponseCmAdvancedgradingInner and assigns it to the Advancedgrading field.
...
func (o *CoreCourseGetCourseModule200ResponseCm) GetOutcomes() []CoreCourseGetCourseModule200ResponseCmOutcomesInner {
	if o == nil || IsNil(o.Outcomes) {
		var ret []CoreCourseGetCourseModule200ResponseCmOutcomesInner
		return ret
	}
	return o.Outcomes
}
...
// SetOutcomes gets a reference to the given []CoreCourseGetCourseModule200ResponseCmOutcomesInner and assigns it to the Outcomes field.
...
func (o CoreCourseGetCourseModule200ResponseCm) MarshalJSON() ([]byte, error) {
...
func (o CoreCourseGetCourseModule200ResponseCm) ToMap() (map[string]interface{}, error) {
...
func (o *CoreCourseGetCourseModule200ResponseCm) UnmarshalJSON(data []byte) (err error) {
	...
	varCoreCourseGetCourseModule200ResponseCm := _CoreCourseGetCourseModule200ResponseCm{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCoreCourseGetCourseModule200ResponseCm)

	if err != nil {
		return err
	}

	*o = CoreCourseGetCourseModule200ResponseCm(varCoreCourseGetCourseModule200ResponseCm)

	return err
}

type NullableCoreCourseGetCourseModule200ResponseCm struct {
	value *CoreCourseGetCourseModule200ResponseCm
	isSet bool
}

func (v NullableCoreCourseGetCourseModule200ResponseCm) Get() *CoreCourseGetCourseModule200ResponseCm {
	return v.value
}

func (v *NullableCoreCourseGetCourseModule200ResponseCm) Set(val *CoreCourseGetCourseModule200ResponseCm) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreCourseGetCourseModule200ResponseCm) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreCourseGetCourseModule200ResponseCm) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreCourseGetCourseModule200ResponseCm(val *CoreCourseGetCourseModule200ResponseCm) *NullableCoreCourseGetCourseModule200ResponseCm {
	return &NullableCoreCourseGetCourseModule200ResponseCm{value: val, isSet: true}
}

func (v NullableCoreCourseGetCourseModule200ResponseCm) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreCourseGetCourseModule200ResponseCm) UnmarshalJSON(src []byte) error {
	v.isSet = true
