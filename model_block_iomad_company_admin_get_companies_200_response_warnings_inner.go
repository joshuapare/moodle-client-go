...
// checks if the BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner{}

// BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner warning
type BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner struct {
	// always set to 'key'
...
func NewBlockIomadCompanyAdminGetCompanies200ResponseWarningsInner() *BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner {
	this := BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner{}
	return &this
}
...
func (o BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner) MarshalJSON() ([]byte, error) {
...
func (o BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner) ToMap() (map[string]interface{}, error) {
...
type NullableBlockIomadCompanyAdminGetCompanies200ResponseWarningsInner struct {
	value *BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner
	isSet bool
}

func (v NullableBlockIomadCompanyAdminGetCompanies200ResponseWarningsInner) Get() *BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner {
	return v.value
}

func (v *NullableBlockIomadCompanyAdminGetCompanies200ResponseWarningsInner) Set(val *BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableBlockIomadCompanyAdminGetCompanies200ResponseWarningsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableBlockIomadCompanyAdminGetCompanies200ResponseWarningsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBlockIomadCompanyAdminGetCompanies200ResponseWarningsInner(val *BlockIomadCompanyAdminGetCompanies200ResponseWarningsInner) *NullableBlockIomadCompanyAdminGetCompanies200ResponseWarningsInner {
	return &NullableBlockIomadCompanyAdminGetCompanies200ResponseWarningsInner{value: val, isSet: true}
}

func (v NullableBlockIomadCompanyAdminGetCompanies200ResponseWarningsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBlockIomadCompanyAdminGetCompanies200ResponseWarningsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
