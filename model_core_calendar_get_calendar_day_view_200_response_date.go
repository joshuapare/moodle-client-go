...
// checks if the CoreCalendarGetCalendarDayView200ResponseDate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoreCalendarGetCalendarDayView200ResponseDate{}

// CoreCalendarGetCalendarDayView200ResponseDate struct for CoreCalendarGetCalendarDayView200ResponseDate
type CoreCalendarGetCalendarDayView200ResponseDate struct {
	// hours
...
type _CoreCalendarGetCalendarDayView200ResponseDate CoreCalendarGetCalendarDayView200ResponseDate
...
func NewCoreCalendarGetCalendarDayView200ResponseDate(hours int32, mday int32, minutes int32, mon int32, month string, seconds int32, timestamp int32, wday int32, weekday string, yday int32, year int32) *CoreCalendarGetCalendarDayView200ResponseDate {
	this := CoreCalendarGetCalendarDayView200ResponseDate{}
	this.Hours = hours
	this.Mday = mday
...
func NewCoreCalendarGetCalendarDayView200ResponseDateWithDefaults() *CoreCalendarGetCalendarDayView200ResponseDate {
	this := CoreCalendarGetCalendarDayView200ResponseDate{}
	var hours int32 = null
	this.Hours = hours
	var mday int32 = null
	this.Mday = mday
	var minutes int32 = null
	this.Minutes = minutes
	var mon int32 = null
	this.Mon = mon
	var month string = "null"
	this.Month = month
	var seconds int32 = null
	this.Seconds = seconds
...
func (o *CoreCalendarGetCalendarDayView200ResponseDate) GetHoursOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Hours, true
...
// and a boolean to check if the value has been set.
func (o *CoreCalendarGetCalendarDayView200ResponseDate) GetMonOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Mon, true
...
// and a boolean to check if the value has been set.
func (o *CoreCalendarGetCalendarDayView200ResponseDate) GetTimestampOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
...
// and a boolean to check if the value has been set.
func (o *CoreCalendarGetCalendarDayView200ResponseDate) GetYdayOk() (*int32, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Yday, true
...
func (o CoreCalendarGetCalendarDayView200ResponseDate) MarshalJSON() ([]byte, error) {
...
func (o CoreCalendarGetCalendarDayView200ResponseDate) ToMap() (map[string]interface{}, error) {
...
func (o *CoreCalendarGetCalendarDayView200ResponseDate) UnmarshalJSON(data []byte) (err error) {
	...
	varCoreCalendarGetCalendarDayView200ResponseDate := _CoreCalendarGetCalendarDayView200ResponseDate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCoreCalendarGetCalendarDayView200ResponseDate)

	if err != nil {
		return err
	}

	*o = CoreCalendarGetCalendarDayView200ResponseDate(varCoreCalendarGetCalendarDayView200ResponseDate)

	return err
}

type NullableCoreCalendarGetCalendarDayView200ResponseDate struct {
	value *CoreCalendarGetCalendarDayView200ResponseDate
	isSet bool
}

func (v NullableCoreCalendarGetCalendarDayView200ResponseDate) Get() *CoreCalendarGetCalendarDayView200ResponseDate {
	return v.value
}

func (v *NullableCoreCalendarGetCalendarDayView200ResponseDate) Set(val *CoreCalendarGetCalendarDayView200ResponseDate) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreCalendarGetCalendarDayView200ResponseDate) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreCalendarGetCalendarDayView200ResponseDate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreCalendarGetCalendarDayView200ResponseDate(val *CoreCalendarGetCalendarDayView200ResponseDate) *NullableCoreCalendarGetCalendarDayView200ResponseDate {
	return &NullableCoreCalendarGetCalendarDayView200ResponseDate{value: val, isSet: true}
}

func (v NullableCoreCalendarGetCalendarDayView200ResponseDate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreCalendarGetCalendarDayView200ResponseDate) UnmarshalJSON(src []byte) error {
	v.isSet = true
