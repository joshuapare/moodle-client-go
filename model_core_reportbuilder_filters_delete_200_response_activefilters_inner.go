...
// checks if the CoreReportbuilderFiltersDelete200ResponseActivefiltersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoreReportbuilderFiltersDelete200ResponseActivefiltersInner{}

// CoreReportbuilderFiltersDelete200ResponseActivefiltersInner struct for CoreReportbuilderFiltersDelete200ResponseActivefiltersInner
type CoreReportbuilderFiltersDelete200ResponseActivefiltersInner struct {
	// entityname
...
func NewCoreReportbuilderFiltersDelete200ResponseActivefiltersInner() *CoreReportbuilderFiltersDelete200ResponseActivefiltersInner {
	this := CoreReportbuilderFiltersDelete200ResponseActivefiltersInner{}
	return &this
}
...
func (o CoreReportbuilderFiltersDelete200ResponseActivefiltersInner) MarshalJSON() ([]byte, error) {
...
func (o CoreReportbuilderFiltersDelete200ResponseActivefiltersInner) ToMap() (map[string]interface{}, error) {
...
type NullableCoreReportbuilderFiltersDelete200ResponseActivefiltersInner struct {
	value *CoreReportbuilderFiltersDelete200ResponseActivefiltersInner
	isSet bool
}

func (v NullableCoreReportbuilderFiltersDelete200ResponseActivefiltersInner) Get() *CoreReportbuilderFiltersDelete200ResponseActivefiltersInner {
	return v.value
}

func (v *NullableCoreReportbuilderFiltersDelete200ResponseActivefiltersInner) Set(val *CoreReportbuilderFiltersDelete200ResponseActivefiltersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreReportbuilderFiltersDelete200ResponseActivefiltersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreReportbuilderFiltersDelete200ResponseActivefiltersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreReportbuilderFiltersDelete200ResponseActivefiltersInner(val *CoreReportbuilderFiltersDelete200ResponseActivefiltersInner) *NullableCoreReportbuilderFiltersDelete200ResponseActivefiltersInner {
	return &NullableCoreReportbuilderFiltersDelete200ResponseActivefiltersInner{value: val, isSet: true}
}

func (v NullableCoreReportbuilderFiltersDelete200ResponseActivefiltersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreReportbuilderFiltersDelete200ResponseActivefiltersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
