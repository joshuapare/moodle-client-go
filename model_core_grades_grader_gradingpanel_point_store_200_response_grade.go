...
// checks if the CoreGradesGraderGradingpanelPointStore200ResponseGrade type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CoreGradesGraderGradingpanelPointStore200ResponseGrade{}

// CoreGradesGraderGradingpanelPointStore200ResponseGrade struct for CoreGradesGraderGradingpanelPointStore200ResponseGrade
type CoreGradesGraderGradingpanelPointStore200ResponseGrade struct {
	// The numeric grade
...
type _CoreGradesGraderGradingpanelPointStore200ResponseGrade CoreGradesGraderGradingpanelPointStore200ResponseGrade
...
func NewCoreGradesGraderGradingpanelPointStore200ResponseGrade(grade float32, gradedby string, maxgrade string, timecreated int32, timemodified int32, usergrade string) *CoreGradesGraderGradingpanelPointStore200ResponseGrade {
	this := CoreGradesGraderGradingpanelPointStore200ResponseGrade{}
	this.Grade = grade
...
func (o CoreGradesGraderGradingpanelPointStore200ResponseGrade) MarshalJSON() ([]byte, error) {
...
func (o CoreGradesGraderGradingpanelPointStore200ResponseGrade) ToMap() (map[string]interface{}, error) {
...
func (o *CoreGradesGraderGradingpanelPointStore200ResponseGrade) UnmarshalJSON(data []byte) (err error) {
	...
	varCoreGradesGraderGradingpanelPointStore200ResponseGrade := _CoreGradesGraderGradingpanelPointStore200ResponseGrade{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCoreGradesGraderGradingpanelPointStore200ResponseGrade)

	if err != nil {
		return err
	}

	*o = CoreGradesGraderGradingpanelPointStore200ResponseGrade(varCoreGradesGraderGradingpanelPointStore200ResponseGrade)

	return err
}

type NullableCoreGradesGraderGradingpanelPointStore200ResponseGrade struct {
	value *CoreGradesGraderGradingpanelPointStore200ResponseGrade
	isSet bool
}

func (v NullableCoreGradesGraderGradingpanelPointStore200ResponseGrade) Get() *CoreGradesGraderGradingpanelPointStore200ResponseGrade {
	return v.value
}

func (v *NullableCoreGradesGraderGradingpanelPointStore200ResponseGrade) Set(val *CoreGradesGraderGradingpanelPointStore200ResponseGrade) {
	v.value = val
	v.isSet = true
}

func (v NullableCoreGradesGraderGradingpanelPointStore200ResponseGrade) IsSet() bool {
	return v.isSet
}

func (v *NullableCoreGradesGraderGradingpanelPointStore200ResponseGrade) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCoreGradesGraderGradingpanelPointStore200ResponseGrade(val *CoreGradesGraderGradingpanelPointStore200ResponseGrade) *NullableCoreGradesGraderGradingpanelPointStore200ResponseGrade {
	return &NullableCoreGradesGraderGradingpanelPointStore200ResponseGrade{value: val, isSet: true}
}

func (v NullableCoreGradesGraderGradingpanelPointStore200ResponseGrade) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCoreGradesGraderGradingpanelPointStore200ResponseGrade) UnmarshalJSON(src []byte) error {
	v.isSet = true
