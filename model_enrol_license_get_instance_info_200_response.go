...
// checks if the EnrolLicenseGetInstanceInfo200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EnrolLicenseGetInstanceInfo200Response{}

// EnrolLicenseGetInstanceInfo200Response struct for EnrolLicenseGetInstanceInfo200Response
type EnrolLicenseGetInstanceInfo200Response struct {
	// id of course
...
type _EnrolLicenseGetInstanceInfo200Response EnrolLicenseGetInstanceInfo200Response
...
func NewEnrolLicenseGetInstanceInfo200Response(courseid int32, id int32, name string, status string, type_ string) *EnrolLicenseGetInstanceInfo200Response {
	this := EnrolLicenseGetInstanceInfo200Response{}
	this.Courseid = courseid
	var enrolpassword string = "null"
...
func (o EnrolLicenseGetInstanceInfo200Response) MarshalJSON() ([]byte, error) {
...
func (o EnrolLicenseGetInstanceInfo200Response) ToMap() (map[string]interface{}, error) {
...
func (o *EnrolLicenseGetInstanceInfo200Response) UnmarshalJSON(data []byte) (err error) {
	...
	varEnrolLicenseGetInstanceInfo200Response := _EnrolLicenseGetInstanceInfo200Response{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEnrolLicenseGetInstanceInfo200Response)

	if err != nil {
		return err
	}

	*o = EnrolLicenseGetInstanceInfo200Response(varEnrolLicenseGetInstanceInfo200Response)

	return err
}

type NullableEnrolLicenseGetInstanceInfo200Response struct {
	value *EnrolLicenseGetInstanceInfo200Response
	isSet bool
}

func (v NullableEnrolLicenseGetInstanceInfo200Response) Get() *EnrolLicenseGetInstanceInfo200Response {
	return v.value
}

func (v *NullableEnrolLicenseGetInstanceInfo200Response) Set(val *EnrolLicenseGetInstanceInfo200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableEnrolLicenseGetInstanceInfo200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableEnrolLicenseGetInstanceInfo200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEnrolLicenseGetInstanceInfo200Response(val *EnrolLicenseGetInstanceInfo200Response) *NullableEnrolLicenseGetInstanceInfo200Response {
	return &NullableEnrolLicenseGetInstanceInfo200Response{value: val, isSet: true}
}

func (v NullableEnrolLicenseGetInstanceInfo200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEnrolLicenseGetInstanceInfo200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
