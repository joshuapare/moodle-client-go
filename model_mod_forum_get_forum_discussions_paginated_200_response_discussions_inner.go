...
// checks if the ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner{}

// ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner post
type ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner struct {
	// Has attachments?
...
func NewModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner() *ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner {
	this := ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner{}
	return &this
}
...
func (o ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner) MarshalJSON() ([]byte, error) {
...
func (o ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner) ToMap() (map[string]interface{}, error) {
...
type NullableModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner struct {
	value *ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner
	isSet bool
}

func (v NullableModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner) Get() *ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner {
	return v.value
}

func (v *NullableModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner) Set(val *ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner(val *ModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner) *NullableModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner {
	return &NullableModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner{value: val, isSet: true}
}

func (v NullableModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModForumGetForumDiscussionsPaginated200ResponseDiscussionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
