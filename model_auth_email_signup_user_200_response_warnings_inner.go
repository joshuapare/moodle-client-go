...
// checks if the AuthEmailSignupUser200ResponseWarningsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AuthEmailSignupUser200ResponseWarningsInner{}

// AuthEmailSignupUser200ResponseWarningsInner warning
type AuthEmailSignupUser200ResponseWarningsInner struct {
	// item
...
func NewAuthEmailSignupUser200ResponseWarningsInner() *AuthEmailSignupUser200ResponseWarningsInner {
	this := AuthEmailSignupUser200ResponseWarningsInner{}
	return &this
}
...
func (o AuthEmailSignupUser200ResponseWarningsInner) MarshalJSON() ([]byte, error) {
...
func (o AuthEmailSignupUser200ResponseWarningsInner) ToMap() (map[string]interface{}, error) {
...
type NullableAuthEmailSignupUser200ResponseWarningsInner struct {
	value *AuthEmailSignupUser200ResponseWarningsInner
	isSet bool
}

func (v NullableAuthEmailSignupUser200ResponseWarningsInner) Get() *AuthEmailSignupUser200ResponseWarningsInner {
	return v.value
}

func (v *NullableAuthEmailSignupUser200ResponseWarningsInner) Set(val *AuthEmailSignupUser200ResponseWarningsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableAuthEmailSignupUser200ResponseWarningsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableAuthEmailSignupUser200ResponseWarningsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAuthEmailSignupUser200ResponseWarningsInner(val *AuthEmailSignupUser200ResponseWarningsInner) *NullableAuthEmailSignupUser200ResponseWarningsInner {
	return &NullableAuthEmailSignupUser200ResponseWarningsInner{value: val, isSet: true}
}

func (v NullableAuthEmailSignupUser200ResponseWarningsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAuthEmailSignupUser200ResponseWarningsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
